---
{"title": "WSL 终端编辑配置危险 — TTy粘贴吞下划线", "domain": "devops", "source": "bootstrap", "bootstrapped": true, "author": "node2", "machine": "hermes-wsl", "original_date": "2026-04-24", "tags": "", "- node": "hermes_wsl", "- project": "wsl", "- severity": "high", "status": "published", "quality": "published", "created": "2026-04-01", "confidence": "0.7"}
---
...
```python
# 用 Python 读写 .env 和 config.yaml（WSL DESKTOP-H9EMUD9）
import json
